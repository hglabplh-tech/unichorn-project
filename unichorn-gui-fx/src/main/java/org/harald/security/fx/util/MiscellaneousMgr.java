...
import org.harald.security.fx.PasswordMgr;
import org.harald.security.fx.SecHarry;

import java.io.File;

public class MiscellaneousMgr {
    ...
    public static TextField getTextFieldByFXID(String fxId) {
        TextField inputField = (TextField) PasswordMgr.fxmlLoader.getNamespace().get(fxId);
        return inputField;
    }

    public static Label getLabelByFXID(String fxId) {
        Label inputField = (Label) PasswordMgr.fxmlLoader.getNamespace().get(fxId);
        return inputField;
    }

    public static ChoiceBox getChoiceBoxByFXID(String fxId)  {
        ChoiceBox choice = (ChoiceBox) PasswordMgr.fxmlLoader.getNamespace().get(fxId);
        return choice;
    }

    public static ComboBox getComboBoxByFXID(String fxId)  {
        ComboBox choice = (ComboBox) PasswordMgr.fxmlLoader.getNamespace().get(fxId);
        return choice;
    }

    public static TextArea getTextAreaByFXID(String fxId)  {
        TextArea choice = (TextArea) PasswordMgr.fxmlLoader.getNamespace().get(fxId);
        return choice;
    }

    public static WebView getWebViewByFXID(String fxId)  {
        WebView choice = (WebView) PasswordMgr.fxmlLoader.getNamespace().get(fxId);
        return choice;
    }

    public static CheckBox getCheckBoxByFXID(String fxId)  {
        CheckBox check = (CheckBox) PasswordMgr.fxmlLoader.getNamespace().get(fxId);
        return check;
    }

    public static ProgressBar getProgessBarByFXID(String fxId)  {
        ProgressBar progress = (ProgressBar) PasswordMgr.fxmlLoader.getNamespace().get(fxId);
        return progress;
    }

    public static ListView getListViewByFXID(String fxId) {
        ListView inputField = (ListView) PasswordMgr.fxmlLoader.getNamespace().get(fxId);
        return inputField;
    }
