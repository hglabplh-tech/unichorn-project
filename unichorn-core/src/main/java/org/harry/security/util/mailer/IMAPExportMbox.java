...
public final class IMAPExportMbox
{
    ...
    public static void main(String[] args) throws IOException, URISyntaxException
    {
        ...
        // Connect and login
        final IMAPClient imap = null; //= //IMAPUtils.imapLogin(uri, connect_timeout * 1000, listener);
    ...
    public static class MboxListener implements IMAPChunkListener {
        ...
        public boolean chunkReceived(IMAP imap) {
            ...
            try {
                ...
                buffer.append(DATE_FORMAT.format(received));
                bw.append(eol);
                item.add(buffer.toString());
                buffer = new StringBuffer();
                // Debug
                bw.append("X-IMAP-Response: ").append(firstLine).append(eol);
                buffer.append("X-IMAP-Response: ").append(firstLine);
                item.add(buffer.toString());
                buffer = new StringBuffer();
                if (printMarker) {
